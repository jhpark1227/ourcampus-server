...
public class Reservation extends BaseEntity {
    ...
    private List<ReservationAlarm> alarms = new ArrayList<>();
    ...
    public void addAlarms(Set<AlarmTiming> alarmTimings) {
        if (alarmTimings == null) {
            return;
        }
        List<ReservationAlarm> reservationAlarms = alarmTimings.stream()
                .map(timing -> new ReservationAlarm(this, timing))
                .toList();
        this.alarms.addAll(reservationAlarms);
    }
